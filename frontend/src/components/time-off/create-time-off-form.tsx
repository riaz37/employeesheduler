...
import { useCreateTimeOffRequest } from '@/hooks/use-time-off';
import { TimeOffType, TimeOffPriority, TimeOffStatus } from '@/types';
import { Form, FormControl, FormField, FormItem, FormLabel, FormMessage } from '@/components/ui/form';
import { Checkbox } from '@/components/ui/checkbox';
import { FormSection } from '@/components/ui/form-section';
import { createTimeOffSchema, type CreateTimeOffFormData } from '@/lib/validations/time-off';

interface CreateTimeOffFormProps {
  onSuccess: () => void;
}

export function CreateTimeOffForm({ onSuccess }: CreateTimeOffFormProps) {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      priority: TimeOffPriority.MEDIUM,
      startDate: '',
      endDate: '',
      startTime: '09:00',
      endTime: '17:00',
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="Brief reason for time-off request (min 10 characters)"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Detailed description of the time-off request (max 1000 characters)"
                      rows={3}
                      {...field}
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Any additional notes or special considerations (max 500 characters)"
                      rows={2}
                      {...field}
                    />
                  </FormControl>

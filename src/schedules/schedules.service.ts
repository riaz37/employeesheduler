...
export class SchedulesService {
  ...
  async create(scheduleData: any): Promise<ScheduleDocument> {
  ...
  async update(id: string, updateScheduleDto: any): Promise<ScheduleDocument> {
    ...
    updateScheduleDto.lastModifiedAt = new Date();
